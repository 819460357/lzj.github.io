    ...
    .then(function (response) {
      return new Promise(function (resolve, reject) {
        ...
        if (data['qr_code'] && data['qr_code'].trim() != '') {
          insertSql += "     , `qr_code` = '" + data['qr_code'] + "'";
        }
        ...
        if (data['company_name'] && data['company_name'].trim() != '') {
          insertSql += "     , `company_name` = '" + data['company_name'] + "'";
        }
        if (data['company_address'] && data['company_address'].trim() != '') {
          insertSql += "     , `company_address` = '" + data['company_address'] + "'";
        }
        if (data['company_tel1'] && data['company_tel1'].trim() != '') {
          insertSql += "     , `company_tel1` = '" + data['company_tel1'] + "'";
        }
        if (data['company_tel2'] && data['company_tel2'].trim() != '') {
          insertSql += "     , `company_tel2` = '" + data['company_tel2'] + "'";
        }
    ...
    .then(function (response) {
      return new Promise(function (resolve, reject) {
        var updateSql =
          ...
          "     , `company_tel1` = '" + (data['company_tel1'] ? data['company_tel1'] : '') + "'" +
          "     , `company_tel2` = '" + (data['company_tel2'] ? data['company_tel2'] : '') + "'" +
          "     , effect = 1" +
          "     , active = 1" +
          "   WHERE id = " + data['id'];
